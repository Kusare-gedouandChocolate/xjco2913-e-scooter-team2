...
SELECT 1, 'Xiaomi M365', 'AVAILABLE', 85, '53.8075,-1.5550', '2026-03-01 10:00:00'
WHERE NOT EXISTS (SELECT 1 FROM scooter WHERE id = 1);

INSERT INTO scooter (id, model, status, battery_level, current_location, created_at)
SELECT 2, 'Ninebot MAX G30', 'IN_USE', 62, '53.8078,-1.5493', '2026-03-01 10:05:00'
WHERE NOT EXISTS (SELECT 1 FROM scooter WHERE id = 2);

INSERT INTO scooter (id, model, status, battery_level, current_location, created_at)
SELECT 3, 'Niu KQi3 Pro', 'MAINTENANCE', 20, '53.8082,-1.5528', '2026-03-01 10:10:00'
WHERE NOT EXISTS (SELECT 1 FROM scooter WHERE id = 3);

INSERT INTO scooter (id, model, status, battery_level, current_location, created_at)
SELECT 4, 'Segway F40', 'LOCKED', 45, '53.8065,-1.5558', '2026-03-01 10:15:00'
WHERE NOT EXISTS (SELECT 1 FROM scooter WHERE id = 4);

INSERT INTO scooter (id, model, status, battery_level, current_location, created_at)
SELECT 5, 'Okai Neon Pro', 'AVAILABLE', 93, '53.8070,-1.5472', '2026-03-01 10:20:00'
WHERE NOT EXISTS (SELECT 1 FROM scooter WHERE id = 5);

INSERT INTO scooter (id, model, status, battery_level, current_location, created_at)
SELECT 6, 'Xiaomi 4 Pro', 'AVAILABLE', 71, '53.8085,-1.5515', '2026-03-01 10:25:00'
WHERE NOT EXISTS (SELECT 1 FROM scooter WHERE id = 6);

-- Booking 1: COMPLETED with battery data
INSERT INTO booking (
    id, user_id, scooter_id, rental_option_id, status,
    total_price, original_price, discount_amount, base_rental_fee,
    overtime_fee, battery_usage_fee, overtime_minutes, battery_usage_percent,
    applied_discount_type, applied_discount_rate,
    start_time, pickup_battery_level, return_battery_level, created_at
)
SELECT
    1,
    '11111111-1111-1111-1111-111111111111',
    1, 1, 'COMPLETED',
    740.00, 500.00, 0.00, 500.00,
    0.00, 240.00, 0, 12,
    NULL, NULL,
    '2026-03-20 10:00:00',
    85, 71,
...
-- Booking 2: AWAITING_PICKUP
INSERT INTO booking (
    id, user_id, scooter_id, rental_option_id, status,
    total_price, original_price, discount_amount, base_rental_fee,
    overtime_fee, battery_usage_fee, overtime_minutes, battery_usage_percent,
    applied_discount_type, applied_discount_rate,
    start_time, pickup_code, pickup_code_expires_at, created_at
)
SELECT
    2,
    '22222222-2222-2222-2222-222222222222',
    2, 2, 'AWAITING_PICKUP',
    1800.00, 1800.00, 0.00, 1800.00,
    0.00, 0.00, 0, 0,
    NULL, NULL,
    '2026-03-21 08:30:00',
    '220002', '2026-03-21 10:05:00',
    '2026-03-21 08:00:00'
WHERE NOT EXISTS (SELECT 1 FROM booking WHERE id = 2);

-- Booking 3: PENDING_PAYMENT (with discount)
INSERT INTO booking (
    id, user_id, scooter_id, rental_option_id, status,
    total_price, original_price, discount_amount, base_rental_fee,
    overtime_fee, battery_usage_fee, overtime_minutes, battery_usage_percent,
...
SELECT
    ...
    5, 4, 'PENDING_PAYMENT',
    29750.00, 35000.00, 5250.00, 29750.00,
    0.00, 0.00, 0, 0,
    'FREQUENT_USER', 15.00,
    '2026-03-25 12:00:00',
    '2026-03-25 11:30:00'
...
-- Booking 4: CANCELLED (should have no battery data)
INSERT INTO booking (
    id, user_id, scooter_id, rental_option_id, status,
    total_price, original_price, discount_amount, base_rental_fee,
    overtime_fee, battery_usage_fee, overtime_minutes, battery_usage_percent,
...
-- Booking 5: COMPLETED with battery and overtime
INSERT INTO booking (
    id, user_id, scooter_id, rental_option_id, status,
    total_price, original_price, discount_amount, base_rental_fee,
    overtime_fee, battery_usage_fee, overtime_minutes, battery_usage_percent,
...
-- Booking 6: IN_PROGRESS (payment done, pickup done)
INSERT INTO booking (
    id, user_id, scooter_id, rental_option_id, status,
    total_price, original_price, discount_amount, base_rental_fee,
    overtime_fee, battery_usage_fee, overtime_minutes, battery_usage_percent,
    applied_discount_type, applied_discount_rate,
    start_time, pickup_code, pickup_code_expires_at, picked_up_at,
    pickup_battery_level, created_at
)
SELECT
    6,
    ...
    NULL, NULL,
    '2026-03-29 09:00:00',
    '220006', '2026-03-29 10:50:00', '2026-03-29 09:00:00',
    81,
    '2026-03-29 08:45:00'
...
UPDATE scooter SET current_location = '53.8075,-1.5550' WHERE id = 1;
UPDATE scooter SET current_location = '53.8078,-1.5493' WHERE id = 2;
UPDATE scooter SET current_location = '53.8082,-1.5528' WHERE id = 3;
UPDATE scooter SET current_location = '53.8065,-1.5558' WHERE id = 4;
UPDATE scooter SET current_location = '53.8070,-1.5472' WHERE id = 5;
UPDATE scooter SET current_location = '53.8085,-1.5515' WHERE id = 6;
